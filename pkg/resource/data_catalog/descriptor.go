...
const (
	finalizerString = "finalizers.athena.services.k8s.aws/DataCatalog"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("datacatalogs")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.DataCatalog{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.DataCatalog),
	}
}
